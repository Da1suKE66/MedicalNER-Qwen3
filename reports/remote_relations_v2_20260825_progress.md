...
- Final remote recovery snapshot: `/temp/liluchen/medicalner_relations_v2/snapshots/final/` (about 6.5 GiB including all retained checkpoints, adapter, plots, logs, reports, config, hashes, and summary); the periodic snapshot loop was stopped only after this final snapshot completed.
